...
public class StateData extends AppCompatActivity {
    ...
    private Statewisemodel stateWiseAdapter;
    private ArrayList<Statewisemodel> stateWiseModelArrayList;
    private SwipeRefreshLayout swipeRefreshLayout;
    private EditText et_search;
    private indiaupdate activity = new indiaupdate();
    ...
    private void Init() {
        ...
        stateWiseAdapter = new Statewisemodel(StateData.this, stateWiseModelArrayList);
